<div>
    ...
    <div class="bg-gray-200 py-4 mb-16 dark:bg-gray-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex">
        <button class="dark:bg-gray-700 dark:text-white bg-white shadow h-12 px-4 rounded-lg mr-4 text-gray-700 focus:outline-none"wire:click="resetFilters">
         ...
         <!-- Dropdown categorias-->
            <div class="relative mr-4" x-data="{open:false}">
                <button class="px-4 dark:bg-gray-700 dark:text-white text-gray-700 block h-12 rounded-lg overflow-hidden focus:outline-none bg-white shadow"x-on:click="open=true">
